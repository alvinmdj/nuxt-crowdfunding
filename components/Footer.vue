<template>
  <footer class="bg-purple-progress py-20 text-white text-lg px-0 sm:px-40">
    <div class="container mx-auto">
      <div class="sm:flex mb-4">
        ...
        <div class="sm:w-1/4 h-auto">
          ...
          <ul class="font-light">
            <li class="mb-3">+099 2233 5577</li>
            <li class="mb-3">Tokyo, Japan</li>
            <li class="mb-3">No.12</li>
            <li class="mb-3">support@crowdfunding.jp</li>
          </ul>
        </div>
      </div>
    </div>
